...
httpd_uri_t postOffTime = {.uri = "/offTime",
                           ...
                           .handler = startEndTimeHandler,
                           .user_ctx = 1};
httpd_uri_t getTemperature = {.uri = "/temperature",
                              .method = HTTP_GET,
                              .handler = httpTemperatureHandler,
                              .user_ctx = NULL};
httpd_uri_t getHumidity = {.uri = "/humidity",
                           .method = HTTP_GET,
                           .handler = httpHumidityHandler,
                           .user_ctx = NULL};
...
httpd_handle_t start_webserver(void) {
  ...
  if (httpd_start(&server, &config) == ESP_OK) {
    ...
    httpd_register_uri_handler(server, &getTemperature);
    httpd_register_uri_handler(server, &getHumidity);
